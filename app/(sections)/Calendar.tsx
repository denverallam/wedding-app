    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                className="text-army-800 space-y-12 md:space-y-16 max-w-4xl relative z-20 flex flex-col items-center w-full"
            >
                {/* Section Header */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center w-full max-w-3xl mx-auto">
                    ...
                    <div className="bg-white/80 backdrop-blur-[2px] p-6 border border-army-200/50 rounded-sm shadow-xs max-w-sm w-full mx-auto">
                        ...
                        <div className="grid grid-cols-7 gap-y-2 text-center text-[9px] font-sans font-semibold tracking-wider text-army-400 uppercase mb-2">
                            <span>S</span><span>M</span><span>T</span><span>W</span><span>T</span><span>F</span><span>S</span>
                        </div>

                        <div className="grid grid-cols-7 gap-y-3 text-center text-xs font-sans font-light text-army-700">
                        ...
                        <div className="space-y-3 w-full pt-2">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 w-full">
                                <a
                                    ...
                                    className="flex-1 text-center py-3 border border-army-300 bg-white/80 hover:bg-army-950 hover:text-white hover:border-army-950 text-army-700 font-sans text-[9px] md:text-[10px] uppercase tracking-[0.2em] transition-all duration-300 shadow-xs cursor-pointer"
                                >
                                    Android
                                </a>
                                <button
